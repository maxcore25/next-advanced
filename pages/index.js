...
const AuthenticatedPanel = dynamic(() => import('./AuthenticatedPanel'));
const NonAuthenticatedPanel = dynamic(() => import('./NonAuthenticatedPanel'));
// * ===== Dynamic Loading =====
...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      ...
      <DynamicH1 />
      {isAuth ? <AuthenticatedPanel /> : <NonAuthenticatedPanel />}
